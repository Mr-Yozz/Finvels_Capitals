...
<head>
    ...
    <style>
        ...
        .badge-paid { background-color: #28a745; color: white; padding: 2px 6px; border-radius: 4px; }
        .badge-pending { background-color: #ffc107; color: black; padding: 2px 6px; border-radius: 4px; }
        .badge-overdue { background-color: #dc3545; color: white; padding: 2px 6px; border-radius: 4px; }
    </style>
</head>
<body>

...
<head>
    ...
    <title>{{ config('app.name', 'Finvels Capitals') }}</title>
    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 ">
        <div>
            <a href="/">
                ...
                <img src="{{ asset('images/finvels.jpeg') }}" alt="Logo" class="logo-img" style="width: 11.5rem; height: 11.5rem; border-radius: 100%;">
            </a>
        </div>
